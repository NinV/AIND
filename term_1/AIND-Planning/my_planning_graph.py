...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            precond_s_nodes[a_node] = a_node.prenodes
            if precond_s_nodes[a_node].issubset(self.s_levels[level]):
        ...
        for a_node in self.a_levels[level]:
            for s_node in self.s_levels[level]:
                if s_node in precond_s_nodes[a_node]:
    ...
    def add_literal_level(self, level):
        ...
        for a_node in self.a_levels[level-1]:
            effect_s_nodes[a_node] = a_node.effnodes
            for e in effect_s_nodes[a_node]:
                s_nodes.add(e)
        ...
        for a_node in self.a_levels[level-1]:
            for s_node in self.s_levels[level]:
                if s_node in effect_s_nodes[a_node]:
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # Check to see whether effects of node_a1 negate the effects of node_a2
        for neg_eff in node_a1.action.effect_rem:
            if neg_eff in node_a2.action.effect_add:
                return True

        # Check to see whether effects of node_a2 negate the effects of node_a1
        for neg_eff in node_a2.action.effect_rem:
            if neg_eff in node_a1.action.effect_add:
                return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # Check to see whether effects of node_a1 negate the precond_pos of node_a2
        for neg_eff in node_a1.action.effect_rem:
            if neg_eff in node_a2.action.precond_pos:
                return True

        # Check to see whether effects of node_a1 negate the precond_neg of node_a2
        for pos_eff in node_a1.action.effect_add:
            if pos_eff in node_a2.action.precond_neg:
                return True

        # Check to see whether effects of node_a2 negate the precond_pos of node_a1
        for neg_eff in node_a2.action.effect_rem:
            if neg_eff in node_a1.action.precond_pos:
                return True

        # Check to see whether effects of node_a2 negate the precond_neg of node_a1
        for pos_eff in node_a2.action.effect_add:
            if pos_eff in node_a1.action.precond_neg:
                return True
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for s_node_1 in node_a1.parents:
            for s_node_2 in node_a2.parents:
                if not s_node_1.is_mutex(s_node_2):
                    return False
        return True
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for a_node_1 in node_s1.parents:
            for a_node_2 in node_s2.parents:
    ...
    def h_levelsum(self) -> int:
        ...
        for sub_goal in self.problem.goal:
            sub_goal = PgNode_s(sub_goal, True)
            for level in range(len(self.s_levels)):
                if sub_goal in self.s_levels[level]:
                    level_sum += level
                    break
        return level_sum
